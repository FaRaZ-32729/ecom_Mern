...
const ListRoom = () => {
    ...
    return (
        <div>
            <Title align="left" title="All Rooms " subTitle="Here you can see and update your all rooms" />
            ...
            <div className="w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll mt-3">
                <table className='w-full'>
                    ...
                    <tbody className='text-sm'>
                        <tr >
                            <td className='py-3 px-4 text-gray-700 border-t border-gray-300 '>Name</td>
                            <td className='py-3 px-4 text-gray-700 border-t border-gray-300  max-sm:hidden'>image</td>
